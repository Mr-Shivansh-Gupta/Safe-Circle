    ...
    <div className="text-slate-300">
      <Container>
        <>
          ...
          <FooterParagraph>
            Safe Circle is a free and Secure Place to Communicate...{" "}
          ...
          <FooterParagraph>
            ...
            <Link external href="mailto:support@SafeCircle.com">
              support@safecircle.com
            </Link>
            .
          </FooterParagraph>
          <FooterParagraph>
          ...
          <FooterParagraph>
            Created by{" "}
            <Link external href="instagram.com/mr_mukku_/">
              Shivansh Gupta
            </Link>
            .
          </FooterParagraph>
